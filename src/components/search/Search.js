...
import { formatSearch } from './../../utils/string-converter'
...
class Search extends Component {
    ...
    handleKeyPressed(e) {
        if (e.charCode === 13) {
            e.length > 0 ? this.props.onSearchFilterChange(formatSearch(e)) : null;
        }
    }
            ...
            >
                <div style={styles.searchContainer}>
                    <AutoComplete
                        ...
                        onUpdateInput={(e) => onSearchFilterChange(formatSearch(e))}
